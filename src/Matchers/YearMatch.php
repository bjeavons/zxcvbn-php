...
final class YearMatch extends BaseMatch
{
    ...
    {
        return [
            'warning' => dgettext("ZxcvbnPhp", "Recent years are easy to guess"),
            'suggestions' => [
                dgettext("ZxcvbnPhp", "Avoid recent years"),
                dgettext("ZxcvbnPhp", "Avoid years that are associated with you"),
            ]
        ];
    }
